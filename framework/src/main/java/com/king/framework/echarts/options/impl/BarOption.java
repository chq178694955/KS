 ...
 * @描述
 */
public class BarOption extends AbstractOption {
    @Override
    public void createOption(String text, List<String> legendData, String xName, List<String> xData, String yName, List<Map<String, Object>> seriesData) {
        ...
        tooltip.setTrigger(TriggerType.ITEM.getVal()) // item axis
        ...
        if(null != seriesData){
            for(Map<String,Object> map : seriesData){
                ...
                SeriesStrategy<Object> strategy = new SeriesStrategy<>(EchartsType.BAR.getVal(),name,data);
