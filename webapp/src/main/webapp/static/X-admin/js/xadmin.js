...
layui.use(['layer','element','jquery'],function() {
    ...
    $('#tab_right').on('click', 'dd', function(event) {
        ...
        if(data_type=='this'){
          $('#mainFrameTab .layui-tab-title li[lay-id='+lay_id+']').find('.layui-tab-close').click();
        }else if(data_type=='other'){
            $('#mainFrameTab .layui-tab-title li').each(function(){
          ...
          $('#mainFrameTab .layui-tab-title li[lay-id]').find('.layui-tab-close').click();
        }
        $('#tab_right').hide();
        $('#tab_show').hide();
    })
