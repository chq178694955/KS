                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="projectName" name="projectName" value="${conf.projectName}" class="layui-input" lay-verify="required" lay-verType="tips">
                                </div>
                            </div>
                            <div class="layui-inline">
                                <label class="layui-form-label"><spring:message code="sys.config.field.name"/></label>
                                <div class="layui-input-inline">
                                    <input type="text" id="remarks" name="remarks" value="${conf.remarks}" class="layui-input" lay-verify="required" lay-verType="tips">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <input type="text" id="text" name="text" value="${conf.remarks}" class="layui-input" lay-verify="required" lay-verType="tips" disabled>
                            </div>
                            <div class="layui-inline">
                                <label class="layui-form-label"><spring:message code="sys.config.field.val"/></label>
                                <div class="layui-input-inline">
                                    <input type="text" id="value" name="value" value="${conf.remarks}" class="layui-input" lay-verify="required" lay-verType="tips">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <textarea name="content" class="layui-textarea">${conf.content}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
