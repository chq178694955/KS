        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <form class="layui-form" action="${ctx}/em/attr/type/add">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label"><spring:message code="em.attr.type.text"/></label>
                                <div class="layui-input-inline">
                                    <input type="text" id="text" name="text" class="layui-input" lay-verify="required" lay-verType="tips">
                                </div>
                            </div>
                            <div class="layui-inline">
                                <label class="layui-form-label"><spring:message code="em.attr.type.value"/></label>
                                <div class="layui-input-inline">
                                    <input type="text" id="value" name="value" class="layui-input" lay-verify="" lay-verType="tips">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
