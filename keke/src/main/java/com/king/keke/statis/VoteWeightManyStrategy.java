 ...
 * 票权从多统计
 */
@Component("voteWeightManyStrategy")
public class VoteWeightManyStrategy implements VoteStrategy {
    private final static Logger logger = LoggerFactory.getLogger(VoteWeightManyStrategy.class);
        ...
        options.forEach((o)->{
            ...
            ticketMap.forEach((k,v)->{
                ...
                if(param.get() != null){
                    ...
                    logger.info("###"+item.getName()+"###，票数：" + v + "，比例：" + rate);
