 ...
 * 票权统计
 */
@Component("voteWeightStrategy")
public class VoteWeightStrategy implements VoteStrategy{

    private final static Logger logger = LoggerFactory.getLogger(VoteWeightStrategy.class);
